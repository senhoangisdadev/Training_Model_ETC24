...
from utils.general import (LOGGER, TQDM_BAR_FORMAT, check_amp, check_dataset,
                           ...
                           methods, one_cycle, one_flat_cycle, print_args,
                           print_mutation, strip_optimizer, yaml_save)
            ...
            if (not nosave) or (final_epoch and not evolve):  # if save
                ...
                if best_fitness == fi:
                    ...
                    if epoch >= 30:
                        ...
                        # put_model_to_minio(f'runs/train/{opt.name}/weights/best.pt')  # Đẩy model lên Minio 
                        save_to_drive(w / f'best.pt','weights')  # Save vào drive
